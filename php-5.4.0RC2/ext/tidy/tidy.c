...
/* $Id: tidy.c 319254 2011-11-15 15:16:20Z felipe $ */
...
static PHP_MINFO_FUNCTION(tidy)
{
	...
	php_info_print_table_row(2, "Extension Version", PHP_TIDY_MODULE_VERSION " ($Id: tidy.c 319254 2011-11-15 15:16:20Z felipe $)");
